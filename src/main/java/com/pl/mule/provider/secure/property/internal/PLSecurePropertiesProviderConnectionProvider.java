 ...
 */
public class PLSecurePropertiesProviderConnectionProvider
    implements PoolingConnectionProvider<PLSecurePropertiesProviderConnection> {

  private final Logger LOGGER = LoggerFactory.getLogger(PLSecurePropertiesProviderConnectionProvider.class);
  ...
  @Override
  public PLSecurePropertiesProviderConnection connect() throws ConnectionException {
    return new PLSecurePropertiesProviderConnection(requiredParameter + ":" + optionalParameter);
  }

  @Override
  public void disconnect(PLSecurePropertiesProviderConnection connection) {
    try {
  ...
  @Override
  public ConnectionValidationResult validate(PLSecurePropertiesProviderConnection connection) {
