 ...
 */
public class PLSecurePropertiesProviderOperations {
  ...
  public String retrieveInfo(@Config PLSecurePropertiesProviderConfiguration configuration,
      @Connection PLSecurePropertiesProviderConnection connection) {
